...
int main()
{
	string a="aebcbda";		//only string A is given in ques, we have to generate reverse A from ourself
	string b = "adbcbea" ;  // reverse A : abcbga, Now, Lcs will be result
...
//	int dp[n+1][m+1]={-1};
	...
	cout<<"Min # of insertion required to make it palindrome: "<<n-ans<<endl;
