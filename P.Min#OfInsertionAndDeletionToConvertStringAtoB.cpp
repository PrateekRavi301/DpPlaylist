...
{
	string a="abcdgh";
	string b="abedfhr";  // delete c,g from A, then insert e, f, r in A 
...
//	int dp[n+1][m+1]={-1};
	...
	cout<<(n-ans) + (m-ans) <<endl;  // answer =  deleting uncommon letters of (a,b) from a + inserting uncommon letters of (a,b) in a
